...
def get_current_user_with_role(*roles: str) -> Callable:
...
RequireManagerDep = Annotated[dict, Depends(get_current_user_with_role("manager", "finance", "admin"))]
RequireFinanceDep = Annotated[dict, Depends(get_current_user_with_role("finance", "admin"))]
RequireAdminDep   = Annotated[dict, Depends(get_current_user_with_role("admin"))]
